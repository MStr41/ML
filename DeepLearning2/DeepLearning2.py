...
if 0==1:#(os.path.exists(path_csv_loss) and os.path.exists(path_csv_val_loss)):
    ...
    for i in range(1, 11, 1):
        ...
        for j in [42, 24, 1, 10, 100]:
            ...
            if 0==1:#os.path.exists(pathFolder):
                    ...
                    df.to_csv(f'{deepLearningDatasFolder}/predictionDeeplearning2_d{i}_v{j}_v2.csv', index=True)
    ...
    all_losses_mean.to_csv(f'{deepLearningDatasFolder}/csv_loss2_v2.csv', index=True)
    all_val_losses_mean.to_csv(f'{deepLearningDatasFolder}/csv_val_loss2_v2.csv', index=True)

    
csv_loss = pd.read_csv(f'{deepLearningDatasFolder}/csv_loss2_v2.csv', delimiter=",")
csv_val_loss = pd.read_csv(f'{deepLearningDatasFolder}/csv_val_loss2_v2.csv', delimiter=",")
print(csv_loss)
print(csv_val_loss)
...
for k in range(0,2,1):
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(fname=f'{deepLearningDatasFolder}/Trainings- und Validierungsverlust2_{k}_v2')
