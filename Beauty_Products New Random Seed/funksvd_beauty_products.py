...
##########################################################################
downsample_method = xf.SampleFrac(1.0 - fraction_value, rng_spec=123)
...
for iterations in iteration_values:
    for features in feature_values:
        seedbank.initialize(123)  # Reset the random seed for reproducibility
        algo_funksvd = FunkSVD(features=features, iterations=iterations, lrate=0.001, reg=0.015, damping=0, bias=False, random_state=123)
...
final_algo = FunkSVD(features=best_features, iterations=best_iterations, lrate=0.001, reg=0.015, damping=0, bias=False, random_state=123)
...
key_name = "funksvd_beauty_products_newRandom"
