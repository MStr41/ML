...
valid_recs, mean_ndcg = evaluate_with_recall('BPR', algo_bpr, downsampled_train_data, validation_data)
...
final_recs, mean_ndcg = evaluate_with_recall('BPR', final_algo, downsampled_train_data, final_test_data)
...
with FileLock(lock_file):
    ...
    if "bpr_goodreads_poetry_recall10" not in content:
        content["bpr_goodreads_poetry_recall10"] = {}

    content["bpr_goodreads_poetry_recall10"][fraction_key] = ndcg_value
