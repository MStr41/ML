...
# Set RecallK as the optimization metric to evaluate at K=10
pipeline_builder.set_optimisation_metric('RecallK', K=10)

# Add RecallK metric to be evaluated at K=10
pipeline_builder.add_metric('RecallK', [10])
...
#################################################
recall_value = metric_results["RecallK_10"].values[0]
key_name = "itemknn_recpack_goodreads_poetry_recall10"
...
with FileLock(lock_file):
    ...
    content[key_name][fraction_key] = recall_value
