...
algo_random = Random()
valid_recs, mean_ndcg = evaluate_with_recall('Random', algo_random, downsampled_train_data, validation_data)
...
final_recs, mean_ndcg = evaluate_with_recall('Random', final_algo, downsampled_train_data, final_test_data)
print(f"Recall mean for test set: {mean_ndcg:.4f}")

#################################################
ndcg_value = mean_ndcg
key_name = "random_goodreads_poetry_recall10"
