...
# Perform validation and compute Recall
algo_bias = Bias(damping = 1000)
valid_recs, mean_ndcg = evaluate_with_recall('Bias', algo_bias, downsampled_train_data, validation_data)
print(f"Recall mean for validation set: {mean_ndcg:.4f}")
...
with FileLock(lock_file):
    ...
    if "bias_goodreads_poetry_recall10" not in content:
        content["bias_goodreads_poetry_recall10"] = {}

    content["bias_goodreads_poetry_recall10"][fraction_key] = ndcg_value
