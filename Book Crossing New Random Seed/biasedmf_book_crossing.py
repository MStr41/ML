...
for iterations in iteration_values:
    for features in feature_values:
        ...
        algo_als = BiasedMF(features=features, iterations=iterations, reg=0.1, damping=0, bias=False, method='cd', rng_spec=123)
...
final_algo  = BiasedMF(features= best_features, iterations=best_iterations, reg=0.1, damping=0, bias=False, method='cd', rng_spec=123)
...
key_name = "biasedmf_book_crossing_new_seed"
