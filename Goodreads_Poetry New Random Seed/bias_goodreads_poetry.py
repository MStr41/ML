...
output_file = "metric_results.json.gz"
...
with FileLock(lock_file):
    ...
    if "bias_goodreads_poetry" not in content:
        content["bias_goodreads_poetry"] = {}

    content["bias_goodreads_poetry"][fraction_key] = ndcg_value
